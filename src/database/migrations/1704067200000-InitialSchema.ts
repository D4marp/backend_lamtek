  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        indices: [
          new TableIndex({ name: 'IDX_users_email', columns: ['email'] }),
          new TableIndex({ name: 'IDX_users_role', columns: ['role'] }),
          new TableIndex({ name: 'IDX_users_status', columns: ['status'] }),
        ],
      }),
      true,
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        indices: [
          new TableIndex({ name: 'IDX_akreditasi_tenantId', columns: ['tenantId'] }),
          new TableIndex({ name: 'IDX_akreditasi_status', columns: ['status'] }),
        ],
      }),
      true,
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        indices: [
          new TableIndex({ name: 'IDX_asesmen_kecukupan_akreditasiId', columns: ['akreditasiId'] }),
        ],
      }),
      true,
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        indices: [
          new TableIndex({ name: 'IDX_asesmen_lapangan_akreditasiId', columns: ['akreditasiId'] }),
        ],
      }),
      true,
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        indices: [
          new TableIndex({ name: 'IDX_dokumen_akreditasiId', columns: ['akreditasiId'] }),
          new TableIndex({ name: 'IDX_dokumen_ipfsHash', columns: ['ipfsHash'] }),
          new TableIndex({ name: 'IDX_dokumen_blockchainHash', columns: ['blockchainHash'] }),
        ],
      }),
      true,
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        indices: [
          new TableIndex({ name: 'IDX_pembayaran_akreditasiId', columns: ['akreditasiId'] }),
          new TableIndex({ name: 'IDX_pembayaran_status', columns: ['status'] }),
        ],
      }),
      true,
    );
