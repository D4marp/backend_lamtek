...
let PengesahanAlService = class PengesahanAlService {
    ...
    async findOne(id) {
        ...
        if (!pengesahan) {
            throw new common_1.NotFoundException(`Pengesahan AL dengan ID ${id} tidak ditemukan`);
        }
        return pengesahan;
    }
    ...
    async sahkan(id, userId, rekomendasiPeringkat) {
        const pengesahan = await this.findOne(id);
        pengesahan.status = pengesahan_al_entity_1.StatusPengesahanAl.DISAHKAN;
    ...
    async tolak(id, catatan) {
        const pengesahan = await this.findOne(id);
        pengesahan.status = pengesahan_al_entity_1.StatusPengesahanAl.DITOLAK;
        pengesahan.catatan = catatan;
        return this.repository.save(pengesahan);
    }
    async revisi(id, catatan) {
        const pengesahan = await this.findOne(id);
        pengesahan.status = pengesahan_al_entity_1.StatusPengesahanAl.REVISI;
        pengesahan.catatan = catatan;
        return this.repository.save(pengesahan);
    }
};
exports.PengesahanAlService = PengesahanAlService;
exports.PengesahanAlService = PengesahanAlService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(pengesahan_al_entity_1.PengesahanAl)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], PengesahanAlService);
//# sourceMappingURL=pengesahan-al.service.js.map