...
exports.KlasterProfesiService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const klaster_profesi_entity_1 = require("../entities/klaster-profesi.entity");
let KlasterProfesiService = class KlasterProfesiService {
    constructor(klasterProfesiRepository) {
        this.klasterProfesiRepository = klasterProfesiRepository;
    }
    ...
    async findOne(id) {
        ...
        if (!klaster) {
            throw new common_1.NotFoundException(`Klaster Profesi dengan ID ${id} tidak ditemukan`);
        }
        return klaster;
    }
    async create(createDto) {
        ...
        if (existing) {
            throw new common_1.ConflictException(`Klaster Profesi dengan kode ${createDto.kodeKlaster} sudah ada`);
        }
    ...
    async update(id, updateDto) {
        ...
        if (updateDto.kodeKlaster && updateDto.kodeKlaster !== klaster.kodeKlaster) {
            ...
            if (existing) {
                throw new common_1.ConflictException(`Klaster Profesi dengan kode ${updateDto.kodeKlaster} sudah ada`);
            }
        }
...
exports.KlasterProfesiService = KlasterProfesiService;
exports.KlasterProfesiService = KlasterProfesiService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(klaster_profesi_entity_1.KlasterProfesi)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], KlasterProfesiService);
//# sourceMappingURL=klaster-profesi.service.js.map